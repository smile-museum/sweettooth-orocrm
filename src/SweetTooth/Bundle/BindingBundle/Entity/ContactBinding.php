 ...
 *
 * @ORM\Entity
 * @ORM\Table(name="sweettooth_contact_binding",
 *  uniqueConstraints={@ORM\UniqueConstraint(name="UNQ_SWEETTOOTH_CONTACT_BINDING_LOCAL_ID", columns={"local_id"})}
 * )
 */
class ContactBinding extends BindingAbstract
{
    /**
     * @var integer
     *
